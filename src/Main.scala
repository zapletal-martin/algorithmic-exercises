...
object Main {
    /*def main(args: Array[String]) {
        println(Queens.queens(4))
    }*/

    /*def main (args: Array[String]) : Unit = {
      val resultGraph = KevinBaconMain.Run ();
    }*/

    /*def main (args: Array[String]) : Unit = {
      val result = RemoveCharactersFromStringMain.Run
      result.toString
    }*/

 /* def main (args: Array[String]) : Unit = {
    println(ReverseWordOrderMain.Run())
  }*/

  /*def main (args: Array[String]) : Unit = {
    println(ReverseWordOrderMain2.Run("Hello, how are you?"))
  }*/
